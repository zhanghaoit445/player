...
public class TestMain extends TabActivity implements TabHost.TabContentFactory{
	...
	//	setContentView(R.layout.tabmove);
	...
	private void initTabHost() {
			m_TabHost.addTab(m_TabHost.newTabSpec("list").setIndicator(
					"音乐列表",getResources().getDrawable(R.drawable.item))
					.setContent(this));
		m_TabHost.addTab(m_TabHost.newTabSpec("artists").setIndicator(
				"艺术家",getResources().getDrawable(R.drawable.artist))
				.setContent(this));
		m_TabHost.addTab(m_TabHost.newTabSpec("albums").setIndicator(
				"专辑",getResources().getDrawable(R.drawable.album))
				.setContent(this));
		m_TabHost.addTab(m_TabHost.newTabSpec("recent").setIndicator(
				"最近播放",getResources().getDrawable(R.drawable.album))
				.setContent(this));
